...
function expectPos(e) {
    LookAheadDistance = Math.abs(pingpong.ball.x - parseInt($(e).css("left")));
    if (e == "#paddleA") {
...
function highExPos(e) {
    if (e == "#paddleA") {
        if (pingpong.ball.directionX == 1) {
            var Pos = expectPos("#paddleB") + pingpong.ball.directionY * (parseInt($("#paddleB").css("left")) - parseInt($("#paddleA").css("left")) + parseInt($("#paddleA").width()));
        } else {
    ...
    if (e == "#paddleB") {
        if (pingpong.ball.directionX == -1) {
            var Pos = expectPos("#paddleA") + pingpong.ball.directionY * (parseInt($("#paddleB").css("left")) - parseInt($("#paddleA").css("left")) + parseInt($("#paddleA").width()));
        } else {
